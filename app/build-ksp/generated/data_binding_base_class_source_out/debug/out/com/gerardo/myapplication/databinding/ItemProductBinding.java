...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull LinearLayout rootView, @NonNull TextView tvAllergens,
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((LinearLayout) rootView, tvAllergens, tvName, tvPrice);
    }
